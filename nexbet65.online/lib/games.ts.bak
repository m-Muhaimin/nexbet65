...
export const CATALOGUE: CatalogueGame[] = [
  ...
  { name: "SuperAce", provider: "SUPRBUILD", category: "slots", emoji: "🃏", rtp: "96.5", gradient: "from-yellow-500 via-amber-900 to-black", tag: "hot", url: "https://superace.suprbuild.com", playable: true },
